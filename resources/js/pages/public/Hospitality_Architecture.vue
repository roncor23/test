      ...
      <div v-show="search" class="tab-content" style="margin-top:100px">
        <div role="tabpanel" class="tab-pane active" id="houses" >
          ...
          <div class="col-lg-4 col-md-6 mb-4" v-for="list_of_building in list_of_buildings" v-cloak>
            <div class="card">
              <span class="" v-if="list_of_building.type == 'architecturalhospitality'" style="cursor: pointer;">
              ...
              <div class="card-body" v-if="list_of_building.type == 'architecturalhospitality'">
                <h6 class="card-title">
     ...
     methods: {
        ...
        architects_portfolio_showcase(type, page) {
         ...
         var ser =  document.getElementById('search').value;
          this.loading = true;
          axios.get('list_hospitality_architecture/building_designs/' + ser).then(result => {
