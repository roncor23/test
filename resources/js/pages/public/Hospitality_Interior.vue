  ...
  <div class="container" style="margin-top:50px">
      <div  class="loading column is-4 is-offset-4 justify-content-center align-items-center row mt-4" v-if="loading" v-cloak>
          ...
          <span class="sr-only">Loading...</span>
  	           ...
  	           <!-- Content Header-->
    <hr id="building" class="hr-text" data-content="Hospitality Interior Designs" style="margin-top:50px">
    ...
    <div v-show="main" class="tab-content" style="margin-top:100px">
        <div role="tabpanel" class="tab-pane active" id="houses" >
          ...
          <div class="col-lg-4 col-md-6 mb-4" v-for="file in files" v-cloak>
            <div class="card">
              <span class="" v-if="file.type == 'interiorhospitality'" style="cursor: pointer;">
              ...
              <div class="card-body" v-if="file.type == 'interiorhospitality'">
                <h6 class="card-title">
      ...
      <div v-show="search" class="tab-content" style="margin-top:100px">
        <div role="tabpanel" class="tab-pane active" id="houses" >
          ...
          <div class="col-lg-4 col-md-6 mb-4" v-for="list_of_building in list_of_buildings" v-cloak>
            <div class="card">
              <span class="" v-if="list_of_building.type == 'interiorhospitality'" style="cursor: pointer;">
              ...
              <div class="card-body" v-if="list_of_building.type == 'interiorhospitality'">
                <h6 class="card-title">
     ...
     methods: {
        ...
        architects_portfolio_showcase(type, page) {
         ...
         var ser =  document.getElementById('search').value;
          this.loading = true;
          axios.get('list_hospitality_interior/building_designs/' + ser).then(result => {
