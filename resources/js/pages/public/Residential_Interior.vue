  ...
  <div class="container" style="margin-top:50px">
    <div  class="loading column is-4 is-offset-4 justify-content-center align-items-center row mt-4" v-if="loading" v-cloak>
          ...
          <span class="sr-only">Loading...</span>
  	           ...
  	           <!-- Content Header-->
    <hr id="building" class="hr-text" data-content="Residential Interior Designs" style="margin-top:50px">
      ...
      <div v-show="search" class="tab-content" style="margin-top:100px">
        <div role="tabpanel" class="tab-pane active" id="houses" >
          ...
          <div class="col-lg-4 col-md-6 mb-4" v-for="list_of_building in list_of_buildings" v-cloak>
            <div class="card">
              <span class="" v-if="list_of_building.type == 'interiorresidential'" style="cursor: pointer;">
              ...
              <div class="card-body" v-if="list_of_building.type == 'interiorresidential'">
                <h6 class="card-title">
     ...
     methods: {
        ...
        list_of_designs(search) {
         ...
         var ser =  document.getElementById('search').value;
          this.loading = true;
          axios.get('list_residential_interior/building_designs/' + ser).then(result => {
