    ...
    return {
     ...
     methods: {
        ...
        Save_profile: function(e) {
            ...
            axios.post('profile_info/constructor', this.formData, {headers: {'content-Type': 'multipart/form-data'}})
                .then(response => {
        ...
        showProf() {
                axios.get('constructor/show_profile/' + this.$route.params.architect_id).then(result => {
        ...
        updateProf() {
            ...
            axios.post('constructor/update_profile/', {val_1: full_name.value, val_2: address1.value, val_3: address2.value, val_4: city.value, val_5: postcode.value, val_6: phone.value, val_7: province.value, val_8: country.value, val_9: birthday.value })
                    .then(response => {
