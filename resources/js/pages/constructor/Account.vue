    ...
    methods: {
      ...
      change_email() {
        ...
        this.formData.append('password', this.password);
            ...
            axios.post('constructor/change_email', this.formData, {headers: {'content-Type': 'multipart/form-data'}})
                .then(response => {
      ...
      change_password() {
        ...
        this.formData.append('cn_password', this.cn_password);
            ...
            axios.post('constructor/change_password', this.formData, {headers: {'content-Type': 'multipart/form-data'}})
                .then(response => {
