      ...
      <div class="container">
        <div class="justify-content-center align-items-center row">
          <div class="col-lg-4 mb-4">
                 <div class="card">
                        <a class="collection-card" href="/residential/architectural-list">   
                          <span>
          ...
          <div class="col-lg-4 mb-4">           
              <div class="card">
                    <a class="collection-card" href="/residential/interior-list">   
                      <span>
...
<script>
  ...
  data() {
    return {
        ...
        architectural_selection: '../image/architectural_residential.jpeg',
        interior_selection: '../image/interior_residential.jpeg',
        routes: {
          // UNLOGGED
          unlogged: [
            {
