<template>
   ...
   <div class="w3-top">
    ...
    <div v-show="main" class="container">  
        <div id="building"></div>
         <!-- Content Header-->
       <hr class="hr-text" style="margin-top: 100px" data-content="Hospitality Collections">
      <div class="container">
        <div class="justify-content-center align-items-center row">
          <div class="col-lg-4 mb-4">
                 <div class="card">
                        <a class="collection-card">   
                          <span>
                            <router-link :to="{name:'user_hospitality.architectural'}"><img class="card-img-top" :src="architectural_selection"></router-link>
                          </span>
          ...
          <div class="col-lg-4 mb-4">           
              <div class="card">
                    <a class="collection-card">   
                      <span>
                        <router-link :to="{name:'user_hospitality.interior'}"><img class="card-img-top" :src="interior_selection"></router-link>
                      </span>
                      <div class="collection-name-container">
...
<script>
  ...
  data() {
    return {
        ...
        architectural_selection: '../image/architectural_hospitality.jpeg',
        interior_selection: '../image/interior_hospitality.jpeg',
        routes: {
          // UNLOGGED
          unlogged: [
            {
