<template>
   ...
   <div class="w3-top">
    ...
    <div class="container" style="margin-top:50px">
      ...
      <div v-show="main"  class="tab-content" style="margin-top:50px">
          <hr id="building" class="hr-text" data-content="Industrial Architectural Designs" style="margin-bottom:50px">
          <div role="tabpanel" class="tab-pane active" id="houses" >
            ...
            <div class="col-lg-4 col-md-6 mb-4" v-for="file in files" v-cloak>
              <div class="card">
                <span class="" v-if="file.type == 'architecturalindustrial'" style="cursor: pointer;">
                ...
                <div class="card-body" v-if="file.type == 'architecturalindustrial'">
                  <h6 class="card-title">
  ...
  <!-- Pagination End -->
        ...
        <div v-show="list_of_all_designs_page" class="container">
                   <!-- Content Header-->
        <hr id="building" class="hr-text" data-content="Building Designs" style="margin-bottom:50px">
  ...
  data() {
    return {
       ...
       files: {},
        ...
        pagination: {},
        offset: 5,
        building: 'architecturalindustrial',
        loading: false,
        errors: {},
