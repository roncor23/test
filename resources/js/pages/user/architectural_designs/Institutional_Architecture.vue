      ...
      <div v-show="main"  class="tab-content" style="margin-top:50px">
          ...
          <div role="tabpanel" class="tab-pane active" id="houses" >
            ...
            <div class="col-lg-4 col-md-6 mb-4" v-for="file in files" v-cloak>
              <div class="card">
                <span class="" v-if="file.type == 'architecturalinstitutional'" style="cursor: pointer;">
                ...
                <div class="card-body" v-if="file.type == 'architecturalinstitutional'">
                  <h6 class="card-title">
  ...
  data() {
    return {
       ...
       files: {},
        ...
        pagination: {},
        offset: 5,
        building: 'architecturalinstitutional',
        loading: false,
        errors: {},
