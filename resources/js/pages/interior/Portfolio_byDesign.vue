                ...
                <div class="col-sm-12 col-md-12 col-lg-6" style="margin-top:43px">
                      <div class="form-row">
                        <div class="form-group col-sm-12 col-md-12 col-lg-12" v-for="display_portfolio in display_portfolios" v-cloak>
                            ...
                            <textarea id="ground_floor" type="number" class="form-control" name="ground_floor" :value="display_portfolio.ground_floor"></textarea>
                            <label style="color: gray; font-size:8pt;">Second Floor</label>
                            <textarea id="second_floor" type="number" class="form-control mt-3" name="second_floor" :value="display_portfolio.second_floor"></textarea>
                            <label style="color: gray; font-size:8pt;">Third Floor</label>
                            <textarea id="third_floor" type="number" class="form-control mt-3" name="third_floor" :value="display_portfolio.third_floor"></textarea>
                            <label style="color: gray; font-size:8pt;">Features</label>
                            <textarea id="features" type="number" class="form-control mt-3" name="features" :value="display_portfolio.features"></textarea>
                        </div> <!-- form-group end.// -->
                    </div> <!-- form-row end.// -->
