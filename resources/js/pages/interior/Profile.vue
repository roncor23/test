    ...
    return {
     ...
     methods: {
        ...
        Save_profile: function(e) {
            ...
            axios.post('profile_info/interior', this.formData, {headers: {'content-Type': 'multipart/form-data'}})
                .then(response => {
        ...
        showProf() {
                axios.get('interiors/show_profile/' + this.$route.params.architect_id).then(result => {
