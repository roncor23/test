...
<div class="container" style="margin-top:100px">
  <v-card>
    <v-card-title>
      List of all interior designers
      <v-spacer></v-spacer>
      <v-text-field
        v-model="search"
        append-icon="search"
    ...
    <v-data-table
      :headers="interior_headers"
      :items="display_all_interiors"
      :search="search"
    >
	...
	export default {
		...
		methods: {
	      ...
	      list_all_interiors() {
	        ...
	        axios.get('display_all/interiors/').then(result => {

	                  this.display_all_interiors = result.data;
	                  console.log(this.display_all_interiors);
